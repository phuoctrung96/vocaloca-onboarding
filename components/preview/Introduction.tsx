    ...
    return (
        <div className='container mx-auto px-4'>
            <div className='py-[100px] w-full'>
                ...
                <h1 className='md:text-5xl text-3xl font-bold text-grey-900 mb-8 mt-4'>
                ...
                <div className="flex md:flex-row flex-col justify-between items-center">
                    ...
                    <button className='md:mt-0 mt-6 text-md text-white px-[55px] py-[14px] max-[450px]:w-full'>Let’s Start Localizing</button>
                </div>
            </div>
        </div>
    )
