    ...
    return (
        <div className='container mx-auto px-4'>
            ...
            <div className="grid md:grid-cols-3 sm:grid-row-3 gap-5 md:py-6 py-4">
                {
                    data.map((item, idx) => (
                        <div className="w-100 md:pb-5 pb:3" key={idx}>
                            ...
                            <p className="text-base text-grey-900 font-bold my-3">{item.title}</p>
                            <div className="mb-4">
                                {
            ...
            <div className="text-center">
                <span className='cursor-pointer md:text-md text-base font-semibold bg-clip-text text-transparent bg-gradient-to-r from-gradient-end to-gradient-via'>Show more</span>
            </div>
        </div>
    )
}
